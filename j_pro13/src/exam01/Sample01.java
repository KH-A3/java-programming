...
public class Sample01 {
	...
	public static void main(String[] args) {
		 ...
		 */
		File f = new File("C:/Users/user2/eclipse/jee-2021-12/eclipse/eclipse.ini");
		...
		File f2 = new File("C:/Users/user2/eclipse/jee-2021-12/eclipse/my_file.wav");
		try {
			f2.createNewFile();
		} catch (IOException e) {
		...
		File f3 = new File("C:/Users/user2/eclipse/jee-2021-12/eclipse/my_folder");
		f3.mkdir();
		
		File f4 = new File("C:/Users/user2/eclipse/jee-2021-12/eclipse/my_file.txt");
		f4.delete();
		
		File f5 = new File("C:/Users/user2/eclipse/jee-2021-12/eclipse");
