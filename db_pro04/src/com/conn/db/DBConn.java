...
public class DBConn {
	...
	public void cloudConnect() throws Exception {
		...
		// 2. DBMS 연결
		Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@db202204211937_low?TNS_ADMIN=C:\\Users\\user2\\eclipse\\oracle\\Wallet_DB202204211937", "puser1", "Database1234");
